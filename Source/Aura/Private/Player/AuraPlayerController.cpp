...
void AAuraPlayerController::SetupInputComponent()
{
	...
	AuraInputComponent->BindAbilityInputs(InputConfig, this, &ThisClass::AbilityInputTagPressed, &ThisClass::AbilityInputTagReleased, &ThisClass::AbilityInputTagHeld);
}
